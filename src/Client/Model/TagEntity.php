...
class TagEntity implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'name' => 'string',
        'timesheets' => '\KimaiConsole\Client\Model\Timesheet[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['timesheets'] = $data['timesheets'] ?? null;
    }
     ...
     * Gets timesheets
     *
     * @return \KimaiConsole\Client\Model\Timesheet[]
     */
     ...
     * Sets timesheets
     *
     * @param \KimaiConsole\Client\Model\Timesheet[] $timesheets timesheets
     *
     * @return $this
     */
