...
/**
 * ActivityMetaField Class Doc Comment
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class ActivityMetaField implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ActivityMetaField';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ActivityMetaField., must be smaller than or equal to 50.');
        }
        if (!is_null($name) && (mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ActivityMetaField., must be bigger than or equal to 2.');
        }
